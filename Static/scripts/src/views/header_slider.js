define(['jquery', 'underscore', 'backbone', 'base/modules/carousel-slider', 'base/modules/animate', 'videojs', 'youtube_video_js', 'base/modules/window-onload'], function ($, _, backbone, carouselSlider, animate, videojs, Youtube, windowOnload) {
