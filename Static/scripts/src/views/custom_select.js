    ...
    function backboneInit(eventDispatcher) {
        return Backbone.View.extend({
            ...
            changeOption: function (event) {
                ...
                var isClickable = $(event.target).parent().css('pointer-event') != 'none';
                console.log($(event.target).parent().css('pointer-event'));
                if (!isClickable)
                    return;
                // Get text and value
                ...
                if (!this._isDisabled()) {
                    ...
                    if (this.$el.find('ul').hasClass('show-select')) {
                        this.$el.find('ul').animate({
                            ...
                            _self.$el.find('ul').toggleClass('show-select');
                        });
                    }
                    else {
            ...
            hideOption: function () {
                if (this.$el.find('ul').hasClass('show-select')) {
                    ...
                    this.$el.find('ul').animate({
                        ...
                        _self.$el.find('ul').removeClass('show-select');
                    });
