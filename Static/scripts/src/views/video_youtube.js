define(['jquery', 'underscore', 'backbone', 'base/modules/video_youtube_module', 'base/modules/eventDispatcher', 'base/modules/utils'], function ($, _, backbone, videoModule, eventDispatcher, utils) {
