...
module.exports = function (grunt) {
        ...
        bowercopy: {
            ...
            deps: {
                files: {
                    ...
                    '<%= project.dirs.scripts.bower %>/jquery.form.js': 'jquery-form/src/jquery.form.js',
    ...
    //grunt.registerTask('deployjs', ["requirejs:deploy"]);
    ...
    grunt.registerTask('episerver', ["build", 'deployjs', 'deploycss']);
};