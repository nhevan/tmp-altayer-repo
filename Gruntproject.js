...
const 
	...
	var dirs = {
	    ...
	    scripts: {
	        ...
	        out: path.join(CLIENT_OUTPUT_DIR, 'js')
	    },
	    styles: {
	        main: CLIENT_STYLES_DIR,
	        partials: path.join(BASE_DIR, 'views/_components'),
	        out: path.join(CLIENT_OUTPUT_DIR, 'css')
	    },
	    images: {
	        main: CLIENT_IMAGES_DIR,
	        out: path.join(CLIENT_OUTPUT_DIR, 'img')
	    },
	    fonts: {
	        main: CLIENT_FONTS_DIR,
	        out: path.join(CLIENT_OUTPUT_DIR, 'fonts')
	    },
	    views: {
	    ...
	    videos: {
	        ...
	        out: path.join(CLIENT_OUTPUT_DIR, 'videos')
	    }
};
